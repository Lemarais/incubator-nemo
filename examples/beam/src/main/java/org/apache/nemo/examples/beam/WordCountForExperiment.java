...
public final class WordCountForExperiment {
  ...
  static Pipeline generateWordCountPipeline(final PipelineOptions options,
    ...
    final PCollection<String> newData = data
      .apply("P=3 Group1 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group1 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group1 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group2 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group2 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group2 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group3 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group4 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group5 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group6 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group7 Do Nothing", ParDo.of(new DoNothingFn()))
      .apply("P=3 Group1 Do Nothing", ParDo.of(new DoNothingFn()));
