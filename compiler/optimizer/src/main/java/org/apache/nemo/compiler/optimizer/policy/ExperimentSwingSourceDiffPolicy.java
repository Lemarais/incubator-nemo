 ...
 */
public final class ExperimentSwingSourceDiffPolicy implements Policy {
  public static final PolicyBuilder BUILDER =
    new PolicyBuilder()
      .registerCompileTimePass(new CustomNodeSelectPass("mulan-12.maas"))
   ...
   * Default constructor.
   */
  public ExperimentSwingSourceDiffPolicy() {
